...
alarm_data = pd.read_csv('./3/Alarm.csv', encoding ='utf')
...
ttpm = TTPM(topology_matrix,delta=0.01,max_hop=2,max_iter=b) #b为确定的最佳迭代次数，[35,20,42,34,53,43,58,48,47,51]
ttpm.learn(X)
...
np.save('./3.npy',est_causal_matrix)
